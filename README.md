            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        ...
                        <!-- โลโก้ SVG -->
                        <!-- 
                          ผมได้ลบ height="100px" width="100px" ออก
                          และใช้คลาส Tailwind 'h-14 w-auto' (สูง 56px) 
                          เพื่อให้โลโก้พอดีกับ Navbar (สูง 80px) ครับ
                        -->
                        ...
                        <!-- นี่คือ 'span' ที่คุณเพิ่มเข้ามา -->
                        <!-- ผมใช้คลาส Tailwind เพื่อจัดสไตล์ตัวอักษร -->
